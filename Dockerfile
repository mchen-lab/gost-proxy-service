# CUSTOM DOCKERFILE - SPECIALIZED FOR GOST
# This file contains custom logic for downloading architecture-specific
# GOST binaries. DO NOT OVERWRITE WITH APP-KIT TEMPLATE.
...
# We use TARGETARCH to select the correct binary (amd64 vs arm64)
RUN GOST_VERSION="3.2.6" && \
